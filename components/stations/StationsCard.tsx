            ...
            <TouchableOpacity onPress={onPress} activeOpacity={0.8}>
                ...
                <View style={styles.infoRow}>
                    <View style={styles.infoItem}>
                        <Zap size={16} color={getStatusColor(station.status)} />
                        <Text style={[styles.infoText, { color: theme.text }]}>{station.power} кВт</Text>
                    </View>
                    ...
                    <View style={styles.infoItem}>
                        <Text
                            style={[
                                ...
                                // {
                                //     color: theme.text,
                                //     backgroundColor: theme.background === "#fff" ? "#EBF4FF" : "#1F2937",
                                // },
                            ]}
                        >
                ...
                <View style={styles.footer}>
                    ...
                    >
                        <View
                            style={[styles.statusDot, { backgroundColor: getStatusColor(station.status) }]}
                        />
